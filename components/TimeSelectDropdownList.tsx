...
type PropTypes = {
    showDateDropdownList: boolean,
    onShowDateDropdownListChange: (value: boolean) => void,
        ...
        <View>
            <View style={[styles.dateContainer]}>
                <Pressable style={styles.dateButton} onPress={() => {
                    onShowDateDropdownListChange(!showDateDropdownList)
                }}>
            ...
            <Modal visible={showDateDropdownList}
                   animationType="slide"
                   transparent={true}
                   onRequestClose={() => onShowDateDropdownListChange(false)}>
                <Pressable style={styles.backdrop} onPress={() => onShowDateDropdownListChange(false)}>
                    <View style={styles.modalContent}>
                        {dateLabelList.map((item) => (
                            <Pressable key={item.dateStr} onPress={() => {
                                dispatch(setDate(item))
                                onShowDateDropdownListChange(false)
                            }}>
...
export default TimeSelectDropdownList;